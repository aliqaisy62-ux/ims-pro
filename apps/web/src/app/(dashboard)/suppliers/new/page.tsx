...
export default function NewSupplierPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    try {
      await suppliersService.create({ ...form, phone: form.phone || null, address: form.address || null, notes: form.notes || null })
      router.push('/suppliers')
    } catch {
      alert('فشل في إنشاء المورد')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div dir="rtl" className="max-w-lg">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">إضافة مورد جديد</h1>
      </div>
