      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="barcode" value={form.barcode} onChange={handleChange} placeholder="يُولَّد تلقائياً إذا ترك فارغاً" className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" />
          </div>
          <div>
